...
Namespace AttendanceBusiness.ServiceImplementations
    Partial Public Class AttendanceBusiness
        ...
        Public Function GetTerminalMeal(ByVal obj As AT_TERMINALSDTO, ByVal log As UserLog) As System.Data.DataTable _
            Implements IAttendanceBusiness.GetTerminalMeal

            Using rep As New AttendanceRepository
                Try
                    Dim lst = rep.GetTerminalMeal(obj, log)
                    Return lst
                Catch ex As Exception
                    Throw ex
                End Try
